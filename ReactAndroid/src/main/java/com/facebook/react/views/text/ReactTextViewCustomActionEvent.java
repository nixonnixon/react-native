 ...
 */
/* package */ class ReactTextViewCustomActionEvent
    extends Event<ReactTextViewCustomActionEvent> {

  public static final String EVENT_NAME = "topCustomActionItemClicked";

  private int mSelectionStart;
  private int mSelectionEnd;

  public ReactTextViewCustomActionEvent(
      int viewId,
      int selectionStart,
      int selectionEnd) {
    super(viewId);
